    ...
    return (
        <MainLayout>
            ...
            className={`sm:w-[80%] mx-auto my-12`}
                src="https://images.unsplash.com/photo-1443037346177-a9dca3e5812e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80" alt=""/>
            <p className={`basic-text text-justify`}>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab adipisci culpa, deleniti magni, nam placeat
