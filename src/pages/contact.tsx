...
const contact = () => {
  return (
    <MainLayout>
      ...
      <PageTitle title='Контакты' description='Аккаунты, учётные записи, контакты и соц. сети автора в одном месте. Свяжитесь если возникли какие-то вопросы или же предложения.' />
