    ...
    return (
        <section className={`${sass.Portfolio} mt-32`} data-scroll-container>
            <div className={`${sass.Head}`} data-scroll>
                ...
                <p className={`${sass.Description} basic-text`} data-scroll data-scroll-speed="1.2">Эти примеры всего лишь "куски" моей работы, остальное вы можете увидеть на <a href="https://github.com/sxnpaii">GitHub</a> профиле</p>
            </div>
                    ...
                    >
                        ...
                        <div className={`${sass.hovered}`}>
                            ...
                            <div className={`${sass.btns} flexbox`}>
                                ...
                                <a className={`btn text-sm md:text-base`} href={record.file_in_tg}>Архив в Телеграме</a>
                                <a className={`btn text-sm md:text-base`} href={record.project_url}>Сам Проект</a>
                            </div>
                        </div>
                    </div>
                ))}
